...
export default function KontaktFormular(){
    return(
        ...
        <form>
            ...
            <input className="navnmail" placeholder='Indtast navn...'/>
            <input className="navnmail" placeholder='Indtast e-mail...'/>
            <input className="besked" placeholder='Skriv besked...'/>
