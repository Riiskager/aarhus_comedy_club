    ...
    <>
      <form className="opretEvent" onSubmit={HandleSubmit}>
        ...
        <input
          ...
          onChange={(e) => setStemImg(e.target.value)}
        ></input>
      ...
      <form className="opretEvent" onSubmit={HandleSubmitKomiker}>
        ...
        <input
          ...
          onChange={(k) => setNavn(k.target.value)}
        ></input>
        ...
        <input
          ...
          value={imgage}
          placeholder="indsæt billedelink"
          onChange={(k) => setImgage(k.target.value)}
        ></input>
        ...
        <input
          ...
          onChange={(k) => setInstagram(k.target.value)}
        ></input>
        ...
        <input
          ...
          onChange={(k) => setFacebook(k.target.value)}
        ></input>
        ...
        <input
          ...
          onChange={(k) => setBooking(k.target.value)}
        ></input>
